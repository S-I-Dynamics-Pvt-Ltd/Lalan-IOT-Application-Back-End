...
public class CustomerRegistrationService {
    ...
    public CustomerRegistrationDTO searchCustomerRegistration(int Cus_id){
    ...
    public String deleteCustomerRegistration(int Cus_id){
      ...
      public List<Map<ActiveObjectMap.Key, Value>> getAllCusDetails() {
        return customerRegistrationRepo.getAllCusDetails();
    }
}
