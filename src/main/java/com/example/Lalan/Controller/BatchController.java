...
public class BatchController {
   ...
   /* @GetMapping
    ...
    //  @GetMapping("/getByJobID/{jobIDBch}")
    // public ResponseEntity getByJobID(@PathVariable String jobIDBch){
    //     try {
    //         List<BatchDTO> batchDTO = batchService.getByJobID(jobIDBch);
    //         if (batchDTO !=null) {
    //             responseDTO.setCode(VarList.RSP_SUCCESS);
    //             responseDTO.setMessage("Success");
    //             responseDTO.setContent(batchDTO);
    ...
    //         } else {
    //             responseDTO.setCode(VarList.RSP_NO_DATA_FOUND);
    //             responseDTO.setMessage("No batch Available For this job ID");
    //             responseDTO.setContent(null);
    //             return new ResponseEntity(responseDTO, HttpStatus.BAD_REQUEST);
    //         }
    //     } catch (Exception e) {
    ...
    public ResponseEntity getByJobID(@PathVariable String jobIDBch) {
        try {
            List<String> batchIDs = batchService.getByJobID(jobIDBch);
