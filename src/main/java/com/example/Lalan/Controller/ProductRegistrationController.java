...
public class ProductRegistrationController {
    ...
    public ResponseEntity saveProduct(@ModelAttribute ProductRegistrationDTO productRegistrationDTO) {
    ...
    public ResponseEntity updateRegisteredProduct(@RequestParam(value = "imageFile", required = false) MultipartFile imageFile,@ModelAttribute ProductRegistrationDTO productRegistrationDTO) {
        try {
    ...
    public ResponseEntity searchRegisteredProduct(@PathVariable String productId) {
        try {
            ProductRegistrationDTO productRegistrationDTO = productRegistrationService
                    .searchRegisteredProduct(productId);
    ...
    @GetMapping("/getAllProductsNameAndIds")
    public List<Map<ActiveObjectMap.Key, Value>> getAllProductsNameAndIds() {
        return productRegistrationService.getAllProductsNameAndIds();
    }
}
