...
public class CustomerRegistrationController {
    ...
    public ResponseEntity searchCustomerRegistration(@PathVariable int cus_id){
        try {
    ...
    public ResponseEntity deleteCustomerRegistration(@PathVariable int cus_id){
        try {
...
@GetMapping("/getAllCusDetails")
public List<Map<ActiveObjectMap.Key, Value>> getAllCusDetails ()
{
    return customerRegistrationService.getAllCusDetails();
}
