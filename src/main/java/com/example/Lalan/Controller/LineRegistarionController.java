...
public class LineRegistarionController {
    ...
    public ResponseEntity saveLine(@ModelAttribute LineRegistrationDTO lineRegistrationDTO){
        try {
    ...
    public ResponseEntity   updateRegisteredLine(@RequestParam(value = "imageFile", required = false) MultipartFile imageFile,@ModelAttribute LineRegistrationDTO lineRegistrationDTO){
        try {
    ...
    @GetMapping("/getAllLineAndId")
    public List<Map<ActiveObjectMap.Key, Value>> getAllLineAndId ()
    {
        return lineRegistrationService.getAllLineAndId();
    }
